...
ACLOCAL = ${SHELL} /media/sf_ERK3/developer/lighttpd/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
ATTR_LIB = 
AUTOCONF = ${SHELL} /media/sf_ERK3/developer/lighttpd/missing autoconf
AUTOHEADER = ${SHELL} /media/sf_ERK3/developer/lighttpd/missing autoheader
AUTOMAKE = ${SHELL} /media/sf_ERK3/developer/lighttpd/missing automake-1.14
AWK = gawk
BZ_LIB = -lbz2
CC = gcc
...
LUA_CFLAGS = 
LUA_LIBS = 
MAKEINFO = ${SHELL} /media/sf_ERK3/developer/lighttpd/missing makeinfo
MANIFEST_TOOL = :
MEMCACHE_LIB = 
MKDIR_P = /bin/mkdir -p
MYSQL_CONFIG = 
...
PACKAGE_STRING = lighttpd 1.4.36
...
XML_LIBS = 
Z_LIB = -lz
abs_builddir = /media/sf_ERK3/developer/lighttpd
abs_srcdir = /media/sf_ERK3/developer/lighttpd
abs_top_builddir = /media/sf_ERK3/developer/lighttpd
abs_top_srcdir = /media/sf_ERK3/developer/lighttpd
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /media/sf_ERK3/developer/lighttpd/install-sh
